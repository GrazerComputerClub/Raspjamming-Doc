...
\subsection{Python}
Um das Python Programm auszuführen muss man wie oben ein Projekt anlegen und
dann unter \texttt{Datei} $\rightarrow$ \texttt{Speichern unter} die
Datei mit dem Namen "`Blink.py"' abspeichern. Nun kann man
den folgenden Python-Source eingeben.
...
Um das Programm auszuführen muss im Menü unter \texttt{Erstellen}
