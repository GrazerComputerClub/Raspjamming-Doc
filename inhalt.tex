...
\textbf{Sollte für die Root-Partition nicht die gesamte Kapazität der SD-Karte verwendet werden, kann über den Menüpunkt "`Advanced Options"' und "`Expand Filesystem"' eine Vergrößerung durchgeführt werden.}\\ 
