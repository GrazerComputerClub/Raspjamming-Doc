...
gibt die Pins anzusprechen. Die GPIOZero Bibliothek verwendet ausschlieﬂlich
die Broadcom Nummerierung (BCM numbering) und dies kann auch nicht auf die
physikalische Nummerierung (BOARD numbering) umgestellt werden. Das Heiﬂt will
